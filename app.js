const STORAGE_KEY = 'intelligibilityMonument.smooth.v7';
const BUILD_VERSION = '2026.06.04-smooth-v7';
...
function toggleModelAuto() {
  ...
  modelAutoTimer = setInterval(() => setModelRotation(modelRotation + 3), 90);
