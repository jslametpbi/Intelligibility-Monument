...
const BUILD_VERSION = '2026.06.04-full-platform-final';
...
function render360Model() {
  ...
  stage.innerHTML = `
    ...
    <div class="model-view-chip">V5 · ${esc(frame.label)} · ${Math.round(modelRotation)}°</div>
...
function toggleModelAuto() {
  ...
  modelAutoTimer = setInterval(() => setModelRotation(modelRotation + 2), 80);
