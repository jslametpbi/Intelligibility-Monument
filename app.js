...
const BUILD_VERSION = '2026.06.04-pro';
...
function initEvents() {
  ...
  byId('clearLocal').addEventListener('click', () => { if (confirm('Clear local browser data?')) { localStorage.removeItem(STORAGE_KEY); state = structuredClone(DEFAULT_STATE); renderAll(); toast('Browser data cleared.'); } });
